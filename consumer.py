...
hdfs_user = 'kartikeykumar690'  # Write your GCP Username here (just the username do not include the Cluster name in it)
...
for message in consumer:
    ...
    if article != last_article:
        ...
        if article.get("url") != "https://removed.com" and article.get("description") != "[Removed]":
            ...
            hdfs_path = '/BigData/FinalProject/news_data.txt'  # Change to your HDFS path
